...
<main>
      <section class="featured section" id="featured">
          <h2 class="section-title">Nos Vetements</h2>
          ...
          <div class="featured__container bd-grid">
              ...
              $image_query = mysqli_query($result, "select nom_vetement,image_vetement,prix_vetement from vetement");
              while ($rows = mysqli_fetch_array($image_query))
              {
                  $img_name = $rows['nom_vetement'];
                  $img_src = $rows['image_vetement'];
                  $img_prx = $rows['prix_vetement']
                  ?>
